...
$arr=array();
$qqer=mysqli_query($connect,"SELECT comments FROM video WHERE ph_no='$pno' ORDER BY ph_no DESC ");
$res=mysqli_fetch_array($qqer);
$cm=mysqli_real_escape_string($connect,$res["comments"]);
$cm1=$cm+1;
$cm2=mysqli_real_escape_string($connect,$cm1);
$qq=mysqli_query($connect,"UPDATE video SET comments='$cm2' WHERE ph_no='$pno' ");
echo $cm2;
?>