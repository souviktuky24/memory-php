...
$var1=mysqli_query($connect, "SELECT cm_no,comment,commenter,liked,liker from vcomments WHERE cm_no='$post_no'  ORDER BY cm_no DESC LIMIT 3 ");
...
$cm=$rs["cm_no"];
$qcs=mysqli_query($connect,"SELECT liker_id FROM vclikes WHERE cm_no='$cm' ORDER BY cm_no DESC  ");
while($rsc=mysqli_fetch_array($qcs))
{
$em1=$rsc["liker_id"];
if($em1==$eid)
{
