...
$(document).on("mouseleave",'.redirectP',function(){
$(this).css({'background-color':'transparent'});
...
<div class="b">
<div class="new1">
<table class="uploadT"><tr><td><p><em>If You Want To Upload Video (Prefrable mp4 Video) Then Please Click On Upload Video Button</em></p></td>
<td><button class="uploadB">Upload Video</button></td></tr></table>
</div>
<div class="new2"></div>
</div>
<div class="c">
