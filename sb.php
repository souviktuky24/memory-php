...
$var=mysqli_query($connect,"INSERT INTO comments(post_no,commenter,comment) VALUES('$post_no','$email','$val') ");
$var1=mysqli_query($connect,"SELECT cm_no,commenter,comment,liked FROM comments WHERE post_no='$post_no' AND commenter='$email' ORDER BY cm_no DESC ");
