...
$var=mysqli_query($connect,"INSERT INTO vcomments(post_no,commenter,comment) VALUES('$post_no','$email','$val') ");
if($var==FALSE)
{
echo "lol";
}
$var1=mysqli_query($connect,"SELECT cm_no,commenter,comment,liked FROM vcomments WHERE post_no='$post_no' AND commenter='$email' ORDER BY cm_no DESC ");
