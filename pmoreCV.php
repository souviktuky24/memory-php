...
$var1=mysqli_query($connect, "SELECT cm_no,comment,commenter,liked from vcomments WHERE post_no='$post_no'  ORDER BY cm_no DESC LIMIT 3 OFFSET $no ");
if($var1)
{
...
$qcs=mysqli_query($connect,"SELECT liker FROM vcomments WHERE cm_no='$cm'  ");
