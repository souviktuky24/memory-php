...
$qr1=mysqli_query($connect,"SELECT post_no,posted_data,likes,comments FROM post1 ORDER BY post_no DESC LIMIT 10 OFFSET $oo  ");
...
$rrees1=$rrees["poster_email"];
$nuy=mysqli_query($connect,"SELECT name FROM shreya_user1 WHERE email='$rrees1' ");
$nuyrs=mysqli_fetch_array($nuy);
