...
$var1=mysqli_query($connect, "SELECT cm_no,comment,commenter from comments WHERE post_no='$post_no' ORDER BY cm_no DESC LIMIT 3 ");
...
while($rs=mysqli_fetch_array($var1))
{
echo '<table class="commentdb"><tr><td><font color="red" size="4"><b><em>'.$rs["commenter"].'</em>   Comments This<b></font></td></tr><tr><td><font color="green" size="3"><b><em>'.$rs["comment"].'</em></b></font></td></tr></table><input type="hidden" class="chhupa" value= '.$rs["cm_no"].'>  <button class="cLike">Like</button>     <button class="remove">Remove Comment</button>';
}
