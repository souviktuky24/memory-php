...
$qr=mysqli_query($connect,"SELECT liked FROM comments WHERE cm_no='$hide' ");
$res=mysqli_fetch_array($qr);
$likes=$res["liked"];
$lk=$likes+1;
$like=mysqli_real_escape_string($connect,$lk);
$qr1=mysqli_query($connect,"UPDATE comments SET liked='$like',liker='$liker' WHERE cm_no='$hide' ");
echo $like;
?>